const testData = {
  questions: [
    ...
    },
    {
      ...
      encryptAnswer: false,
      questionPrompt:
        "Is this your first time filling out NEXT's enrollment application?",
      questionType: 'dropdown',
      possibleAnswers: [
        'Yes',
    ...
    },
    {
      ...
      encryptAnswer: false,
      questionPrompt:
        'Where do you currently obtain injection related supplies?',
      questionType: 'input',
    },
    {
      // ne question 4
    ...
    },
    {
      ...
      questionType: 'radio',
      possibleAnswers: ['Yes', 'No', "I'm not sure"],
    },
    {
      // ne question 18
      tag: 'nextEnrollment',
    ...
    },
    {
      ...
      required: false,
      questionPrompt:
        'Have you had issues related to abscesses, cellulitis, or endocarditis? Please explain.',
      questionType: 'input',
    },
    {
      // ne question 21
    ...
    },
    {
      ...
      encryptAnswer: false,
      questionPrompt:
        'Are you parenting / do you have children at your residence?',
      questionType: 'radio',
      possibleAnswers: ['Yes', 'No'],
    },
    {
    ...
    },
    {
      ...
      encryptAnswer: false,
      questionPrompt:
        'How / where do you currently dispose of syringes? Please be specific.',
      questionType: 'input',
    },
    {
      // ne question 29
    ...
    },
    {
      ...
      questionType: 'radio',
      possibleAnswers: ['No', 'Yes, often', 'Yes, rarely'],
    },
    {
      // ne question 32
      tag: 'nextEnrollment',
      ...
      encryptAnswer: false,
      questionPrompt:
        'How often have you reused your own syringes in the past month?',
      questionType: 'input',
    },
    {
      // ne question 33
      ...
      encryptAnswer: false,
      questionPrompt:
        'How often have you shared syringes with another person in the past month?',
      questionType: 'input',
    },
    {
      // ne question 34
      ...
      questionType: 'radio',
      possibleAnswers: ['Yes', 'No', "I don't know/ I don't remember"],
    },
    {
      // ne question 35
      tag: 'nextEnrollment',
    ...
    },
    {
      ...
      required: false,
      questionPrompt:
        'Is there anything else you want us to know about you, your history, or situation?',
      questionType: 'input',
    },
    {
      // ne question 37
      ...
      encryptAnswer: false,
      questionPrompt:
        'In addition to getting supplies for you, how many other people do you plan to get supplies from NEXT for?',
      questionType: 'dropdown',
      possibleAnswers: [
    ...
    },
    {
      ...
      encryptAnswer: false,
      questionPrompt:
        'Related to security of packages containing injection related supplies:',
      questionType: 'dropdown',
      possibleAnswers: [
    ...
    },
    {
      ...
      encryptAnswer: false,
      questionPrompt:
        'What else should we know about sending you supplies or communicating with you?',
      questionType: 'input',
    },
    {
      // ne question 40
